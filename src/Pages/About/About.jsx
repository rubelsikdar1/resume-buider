    ...
    return (
        <Flex
            ...
            _after={{
                ...
                backgroundImage: `url("https://ibb.co/F3PC595")`,
            }}
            _before={{
                content: '""',
                position: 'absolute',
            ...
            <Flex
                ...
                <a href={"https://about.me/rubelsikdar"} >
                    {name}
                    <chakra.span
                        fontFamily={'Inter'}
                        fontWeight={'medium'}
    ...
    return (
        <>
            <Helmet>
                ...
                <meta name="author" content="Rubel Sikdar" />
                ...
                <meta property="og:url" content="https://about.me/rubelsikdar" />
